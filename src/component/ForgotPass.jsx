      ...
      >
        ...
        <form onSubmit={handleSubmit} className="absolute top-28 left-72 right-100 border-8 rounded-lg border-solid border-blue-300 p-5 bg-gray-200">
          <div className="w-[60vh] p-10">
            <h1 className="text-4xl font-bold font-poppins text-blue-500 text-center mb-3">Find Account</h1>
            <p className="m-2 text-blue-400 font-poppins font-semibold text-lg text-left">
              Email
            </p>
            <input type="email" name="email" placeholder="abc@gmail.com" onChange={(e) => setEmail(e.target.value)} className="w-full h-[80] py-2 px-3 rounded-lg border border-blue-500 hover:border-blue-900 hover:border-2" />
